...
cc -Wall -Wextra -Werror -o ft_ultimate_ft ft_ultimate_ft.c main.c
if [ $? -ne 0 ]; then
...
longest_test="$> ./ft_ultimate_ft -456 | cat -e"
...
run_test() {
	...
	echo "$separator"
	echo "$> ./ft_ultimate_ft $input | cat -e"

	output=$(./ft_ultimate_ft $input | cat -e)
...
run_test "0" "42$" || all_tests_passed=false
run_test "123" "42$" || all_tests_passed=false
run_test "-456" "42$" || all_tests_passed=false
